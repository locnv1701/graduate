<?php
    ...
    $g_lang["click_to_add_vertex"] = "Кликните на рабочую область, чтобы добавить вершину. <span style=\"float:right;\">Нумерация вершин <select id=\"enumVertexsText\"></select></span>";
    $g_lang["select_first_vertext_to_connect"] = "Выделите первую вершину";
