<?php
    ...
    define('SITE_IN_DIR',   'graphonline');  // Если сайт работает в каталоге напишите здесь каталог пример "cabinet" или "book/php"
    define('DOMAIN_COOKIE', '');

    // Массив языков сайта

    // sửa "ru" thằng "en" để chuyển ngôn ngữ default sang tiếng anh
    define('DEF_LANG', 'en');
    $g_arrLangs = array(
